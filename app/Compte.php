...
{
    protected $fillable = array('clients_id','users_id','numero','rib','date_ouverture','raison_social','salaire','nom_employeur','tel_employeur','numero_identification','agios','frais_ouverture','remuneration','date_debut','date_fin');
